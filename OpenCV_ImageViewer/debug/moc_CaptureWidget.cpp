...
QT_MOC_LITERAL(1, 14, 18), // "sigSendCaptureRect"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 4) // "rect"

    },
    "CaptureWidget\0sigSendCaptureRect\0\0"
    "rect"
};
...
void CaptureWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigSendCaptureRect((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureWidget::*)(QRect );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureWidget::sigSendCaptureRect)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureWidget::sigSendCaptureRect(QRect _t1)
{
